<div x-show="editPackage" class="w-3/4" x-cloak>
    <x-modalCustom>
        ...
        <div class="p-3" wire:ignore>
            <x-input-label for="description2" :value="__('Description')" />
            <textarea id="description2" rows="4" name="description2"
                class="block mt-1 p-2.5 w-full text-sm text-gray-900  rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">{!! $description2 !!}</textarea>
