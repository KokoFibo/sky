<div x-show="editInvoice" class="w-3/4" x-cloak>
    <x-modalCustom>
        <h2 class="mt-3 text-2xl font-semibold text-center">Update Invoice</h2>
        <hr class="px-3 my-2">
        ...
        <div class="flex justify-between">
            <x-blue-button class="m-3" @click="editInvoice=false" wire:click="updateInvoice">
                {{ __('Update') }}
            </x-blue-button>
            <x-primary-button class="m-3" @click="editInvoice=false" wire:click="clear">
                {{ __('Cancel') }}
            </x-primary-button>
        </div>
