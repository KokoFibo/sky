<div>
    <div class="bg-gray-100 w-full min-h-screen gap-4 flex-wrap flex justify-center items-center">
        ...
        <div
            ...
            <div class="p-2">
                <!-- Heading -->
                <h2 class="font-bold text-lg mb-2 ">Expiring Contracts</h2>
                <!-- Description -->
            ...
            <div class="m-2">
                <a role='button' href='#'
                    class="text-white bg-purple-600 px-3 py-1 rounded-md hover:bg-purple-700">Learn More</a>
            </div>
        </div>
        <!-- Card -->
        <div
            ...
            <div class="p-2">
                <!-- Heading -->
                <h2 class="font-bold text-lg mb-2 ">Active Client</h2>
                <!-- Description -->
                <p class="text-sm text-gray-600">Simple Yet Beautiful Card Design with TaiwlindCss. Subscribe to our
                    Youtube channel for more ...</p>
            </div>
